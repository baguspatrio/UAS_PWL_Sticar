                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo  $key->posisi ?></td>
          					<td><a class="btn btn-primary" href="<?php echo base_url('Display/verivikasi/'.$key->idPengiklan)  ?>" >VERIFIKASI</a><a class="btn btn-danger" href="<?php echo base_url('Display/deletepengiklan/'.$key->idPengiklan) ?>"onclick="return confirm('Apakah Anda Yakin Akan Ingin Menghapus Data Ini ?')">DELETE</a></td>  
                  </tr>
                 	<?php } ?>
